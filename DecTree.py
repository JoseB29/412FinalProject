...
def apply_decision_tree_model(input_data):
    """
    ...
    features = ['tmin', 'tmax', 'snow', 'wdir', 'wspd', 'pres']
    input_data = input_data[features]
    
    # Make predictions
    predicted_tavg = model_tavg.predict(input_data)
    predicted_prcp = model_prcp.predict(input_data)
